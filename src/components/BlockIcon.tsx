...
const ICONS: Record<string, React.FC<IconProps>> = {
  ...
  base_sink: BaseSink,
  base_sink_double: BaseSink,
  base_oven_integrated: ApplOvenBuilt,
  appl_dishwash_integrated: ApplDishwasher,
  wall_1door: WallSingle,
  wall_2door: WallDouble,
  wall_glass: WallGlass,
  wall_lift: WallLift,
  appl_microwave_built: ApplOvenBuilt,
  tall_pantry: TallPantry,
  tall_oven: TallOven,
  tall_oven_micro: TallOven,
  tall_fridge: TallFridge,
  appl_fridge_side: TallFridge,
  appl_fridge_mini: TallFridge,
  appl_stove: ApplStove,
  appl_stove_5: ApplStove,
  appl_cooktop: ApplStove,
  appl_oven: ApplOvenBuilt,
  appl_hood: ApplHood,
  appl_hood_chimney: ApplHood,
  appl_hood_island: ApplHood,
  appl_dishwash: ApplDishwasher,
  appl_washer: ApplDishwasher,
  appl_microwave: ApplOvenBuilt,
